...
export type FeedbackManyWhereInput = {
  ...
  /** All values that are contained in given list. */
  feedbacks_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  ...
  /** All values that are not contained in given list. */
  feedbacks_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
...
export type SubscriberManyWhereInput = {
  ...
  /** All values that are contained in given list. */
  avatar_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  ...
  /** All values that are not contained in given list. */
  avatar_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
...
export type CreateCommentMutation = { __typename?: 'Mutation', createFeedback?: { __typename?: 'Feedback', id: string } | null };

export type CreateCommentAndSubscriberMutationVariables = Exact<{
  comment?: InputMaybe<Scalars['String']>;
  slug?: InputMaybe<Scalars['String']>;
  name: Scalars['String'];
  email: Scalars['String'];
...
export type CreateCommentAndSubscriberMutation = { __typename?: 'Mutation', createFeedback?: { __typename?: 'Feedback', id: string } | null };
...
export type CreateSubscribeMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string, name: string, email: string, avatar?: string | null } | null };
...
export type DeleteCommentMutation = { __typename?: 'Mutation', deleteFeedback?: { __typename?: 'Feedback', id: string } | null };
...
export type UpdateCommentMutation = { __typename?: 'Mutation', updateFeedback?: { __typename?: 'Feedback', id: string } | null };
...
export type GetLessonDataQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', name: string, bio: string, avatarURL: string } | null } | null, feedbacks: Array<{ __typename?: 'Feedback', id: string, createdAt: any, updatedAt: any, feedbacks?: string | null, subscriber?: { __typename?: 'Subscriber', id: string, name: string, avatar?: string | null } | null }> };
...
export type GetSubscribeEmailQueryVariables = Exact<{
  email: Scalars['String'];
}>;


export type GetSubscribeEmailQuery = { __typename?: 'Query', subscriber?: { __typename?: 'Subscriber', id: string, name: string, email: string, avatar?: string | null } | null };

export type GetSubscribeIdQueryVariables = Exact<{
  id?: InputMaybe<Scalars['ID']>;
}>;


export type GetSubscribeIdQuery = { __typename?: 'Query', subscriber?: { __typename?: 'Subscriber', id: string, name: string, email: string, avatar?: string | null } | null };


export const CreateCommentDocument = gql`
    mutation createComment($comment: String, $slug: String, $id: ID) {
  createFeedback(
    data: {feedbacks: $comment, lesson: {connect: {slug: $slug}}, subscriber: {connect: {id: $id}}}
  ) {
    id
  }
}
...
export const CreateCommentAndSubscriberDocument = gql`
    mutation createCommentAndSubscriber($comment: String, $slug: String, $name: String!, $email: String!, $avatar: String) {
  createFeedback(
    data: {feedbacks: $comment, lesson: {connect: {slug: $slug}}, subscriber: {create: {name: $name, email: $email, avatar: $avatar}, connect: {email: $email}}}
  ) {
    id
  }
}
    `;
export type CreateCommentAndSubscriberMutationFn = Apollo.MutationFunction<CreateCommentAndSubscriberMutation, CreateCommentAndSubscriberMutationVariables>;

/**
 * __useCreateCommentAndSubscriberMutation__
 *
 * To run a mutation, you first call `useCreateCommentAndSubscriberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateCommentAndSubscriberMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createCommentAndSubscriberMutation, { data, loading, error }] = useCreateCommentAndSubscriberMutation({
 *   variables: {
 *      comment: // value for 'comment'
 *      slug: // value for 'slug'
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreateCommentAndSubscriberMutation(baseOptions?: Apollo.MutationHookOptions<CreateCommentAndSubscriberMutation, CreateCommentAndSubscriberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateCommentAndSubscriberMutation, CreateCommentAndSubscriberMutationVariables>(CreateCommentAndSubscriberDocument, options);
      }
export type CreateCommentAndSubscriberMutationHookResult = ReturnType<typeof useCreateCommentAndSubscriberMutation>;
export type CreateCommentAndSubscriberMutationResult = Apollo.MutationResult<CreateCommentAndSubscriberMutation>;
export type CreateCommentAndSubscriberMutationOptions = Apollo.BaseMutationOptions<CreateCommentAndSubscriberMutation, CreateCommentAndSubscriberMutationVariables>;
export const CreateSubscribeDocument = gql`
    mutation createSubscribe($name: String!, $email: String!, $avatar: String) {
  createSubscriber(data: {name: $name, email: $email, avatar: $avatar}) {
    id
    name
    email
    avatar
...
export const UpdateCommentDocument = gql`
    mutation updateComment($comment: String, $id: ID) {
  updateFeedback(data: {feedbacks: $comment}, where: {id: $id}) {
    id
  }
}
    `;
...
export const GetSubscribeEmailDocument = gql`
    query getSubscribeEmail($email: String!) {
...
/**
 * __useGetSubscribeEmailQuery__
 *
 * To run a query within a React component, call `useGetSubscribeEmailQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetSubscribeEmailQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetSubscribeEmailQuery({
 *   variables: {
 *      email: // value for 'email'
 *   },
 * });
 */
export function useGetSubscribeEmailQuery(baseOptions: Apollo.QueryHookOptions<GetSubscribeEmailQuery, GetSubscribeEmailQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSubscribeEmailQuery, GetSubscribeEmailQueryVariables>(GetSubscribeEmailDocument, options);
      }
export function useGetSubscribeEmailLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSubscribeEmailQuery, GetSubscribeEmailQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSubscribeEmailQuery, GetSubscribeEmailQueryVariables>(GetSubscribeEmailDocument, options);
        }
export type GetSubscribeEmailQueryHookResult = ReturnType<typeof useGetSubscribeEmailQuery>;
export type GetSubscribeEmailLazyQueryHookResult = ReturnType<typeof useGetSubscribeEmailLazyQuery>;
export type GetSubscribeEmailQueryResult = Apollo.QueryResult<GetSubscribeEmailQuery, GetSubscribeEmailQueryVariables>;
export const GetSubscribeIdDocument = gql`
    query getSubscribeID($id: ID) {
...
/**
 * __useGetSubscribeIdQuery__
 *
 * To run a query within a React component, call `useGetSubscribeIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetSubscribeIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetSubscribeIdQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetSubscribeIdQuery(baseOptions?: Apollo.QueryHookOptions<GetSubscribeIdQuery, GetSubscribeIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSubscribeIdQuery, GetSubscribeIdQueryVariables>(GetSubscribeIdDocument, options);
      }
export function useGetSubscribeIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSubscribeIdQuery, GetSubscribeIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSubscribeIdQuery, GetSubscribeIdQueryVariables>(GetSubscribeIdDocument, options);
        }
export type GetSubscribeIdQueryHookResult = ReturnType<typeof useGetSubscribeIdQuery>;
export type GetSubscribeIdLazyQueryHookResult = ReturnType<typeof useGetSubscribeIdLazyQuery>;
export type GetSubscribeIdQueryResult = Apollo.QueryResult<GetSubscribeIdQuery, GetSubscribeIdQueryVariables>;